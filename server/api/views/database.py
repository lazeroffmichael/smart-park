"""
Handles the database management for updating the spots with the user information once it is pressed.
"""
from flask import Blueprint
from flask_restful import Resource, reqparse

database_instantiate = Blueprint('database_populate', __name__)

# Database management
# TODO: This could not be used in production
import os
...
class DatabaseInstantiateAPI(Resource):
    ...
    def put(self):
        """
        Make a put request to this endpoint to instantiate the database
        Returns: {}, 201 (created)
